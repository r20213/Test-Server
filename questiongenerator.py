...
# parser.add_argument('text_path', type=str,help='text to test the _split_into_segments function.')
# args = parser.parse_args()

class QuestionGenerator:
  def __init__(self, model_dir=None):
    QG_PRETRAINED = "iarfmoose/t5-base-question-generator" # This model is a sequence-to-sequence question generator which takes an answer and context as an input, and generates a question as an output. It is based on a pretrained t5-base model.
  ...
  def _split_text(self, text):
        ...
        sentences = re.findall(".*?[.!\?]", text) # https://stackoverflow.com/questions/3075130/what-is-the-difference-between-and-regular-expressions
  ...
  def _prepare_qg_inputs_MC(self, sentences):
        ...
        print(f"Output of nlp.pipe (docs) : {docs}")
        inputs_from_text = []
        answers_from_text = []

        for i in range(len(sentences)):
            entities = docs[i].ents
            print(f"Entities (from _prepare_qg_inputs_MC) : {entities}")
            if entities:
  ...
  def _get_MC_answers(self, correct_answer, docs):
        ...
        print(f'entities (from _get_MC_answers): {entities}.')
        # remove duplicate elements
        entities_json = [json.dumps(kv) for kv in entities]
        print('entities_json',entities_json)
  ...
  def _generate_question(self, qg_input):
        ...
        print(f'From _generate_question : output : {output}.')
...
if __name__ == '__main__':
  ...
  """Testing _split_into_segments()"""
  # d = qg._split_into_segments(text)
  # print(d)
  """Testing _prepare_qg_inputs_MC()"""
  sentences = qg._split_into_segments(text)
  inputs_from_text, answers_from_text = qg._prepare_qg_inputs_MC(sentences)
  # print(inputs_from_text)
  # print(len(inputs_from_text))
  # print(answers_from_text)
  # print(len(answers_from_text))
  """Testing _get_MC_answers()"""